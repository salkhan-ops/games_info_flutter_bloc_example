...
import 'package:gameinfo/repository/models/model_barrel.dart';
import 'package:gameinfo/repository/models/result_error.dart';
import '../models/genre.dart';

class GameService {
  GameService(
      {http.Client? httpClient, this.baseUrl = 'https://api.rawg.io/api'})
